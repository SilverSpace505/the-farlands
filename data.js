...
var blocks = {
	...
	/*27*/ "jungleLeaves": [[8, 2], [8, 2], [8, 2], [8, 2], [8, 2], [8, 2], false, "jungleLeaves"],
...
var characters = {
	...
	"p": [15, 1],"q": [16, 1],"r": [17, 1],
	"s": [18, 1],"t": [19, 1],"u": [20, 1],
...
function getBlock(x, y, z, raw=true, ignore=false, trueRaw=true, col=false) {
	x = Math.floor(x)
	y = Math.floor(y)
	z = Math.floor(z)
